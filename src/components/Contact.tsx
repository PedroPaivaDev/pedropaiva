const Contact = () => {
  return (
    <section className='wrapper gap-5' id='Contato'>
      <h2>Contatos</h2>
      <div className='flex gap-5'>
        <a href='https://www.linkedin.com/in/pedroengenheirocivil/' target='_blank'>
          <svg className='hover:fill-white duration-300' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#000000" viewBox="0 0 256 256">
