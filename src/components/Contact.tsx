const Contact = () => {
  return (
    <section id='Contato'>
      <h2>Contatos</h2>
      <div className='shadowBg flex gap-5'>
        <a href='https://www.linkedin.com/in/pedroengenheirocivil/' title="Linkedin" aria-label="Linkedin" target='_blank'>
          <svg className='fill-moodboard-light hover:fill-moodboard-salmon duration-300' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#000000" viewBox="0 0 256 256">
            <path d="M216,24H40A16,16,0,0,0,24,40V216a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V40A16,16,0,0,0,216,24Zm0,192H40V40H216V216ZM96,112v64a8,8,0,0,1-16,0V112a8,8,0,0,1,16,0Zm88,28v36a8,8,0,0,1-16,0V140a20,20,0,0,0-40,0v36a8,8,0,0,1-16,0V112a8,8,0,0,1,15.79-1.78A36,36,0,0,1,184,140ZM100,84A12,12,0,1,1,88,72,12,12,0,0,1,100,84Z"/>
          </svg>
        </a>
        <a href='https://github.com/PedroPaivaDev' title="GitHub" aria-label="GitHub" target='_blank'>
          <svg className='fill-moodboard-light hover:fill-moodboard-salmon duration-300' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#000000" viewBox="0 0 256 256">
        ...
        <a href='mailto:pedropaivadev@gmail.com' title="E-mail" aria-label="E-mail" target='_blank'>
          <svg className='fill-moodboard-light hover:fill-moodboard-salmon duration-300' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#000000" viewBox="0 0 256 256">
            <path d="M224,48H32a8,8,0,0,0-8,8V192a16,16,0,0,0,16,16H216a16,16,0,0,0,16-16V56A8,8,0,0,0,224,48ZM203.43,64,128,133.15,52.57,64ZM216,192H40V74.19l82.59,75.71a8,8,0,0,0,10.82,0L216,74.19V192Z"/>
          </svg>
        </a>
        <a href='https://discord.com/users/#8726' title="Discord" aria-label="Discord" target='_blank'>
          <svg className='fill-moodboard-light hover:fill-moodboard-salmon duration-300' xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#000000" viewBox="0 0 256 256">
