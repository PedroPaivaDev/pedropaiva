const projectsDB:ProjectsDB = {
  ppRestaurante: {
    id: "ppRestaurante",
    type: "original",
    title: "PP-Restaurante",
  ...
  pedropaiva: {
    ...
    type: "original",
    title: "Portfólio",
    description: "Aplicação do meu portfólio de projetos.",
  ...
  nlwSpacetimeIgnite: {
    ...
    description: "Aplicação desenvolvida durante o bootcamp NLW, edição 12 - Spacetime, oferecido pela Rocketseat durante os dias 15 a 19 de Maio de 2023, lecionado pelo professor Diego Fernandes.",
